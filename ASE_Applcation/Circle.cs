...
namespace ASE_Applcation
{
    public class Circle : Shape
    {
        ...
        /// <param name="x">the x coordinate the center of the circle</param>
        /// <param name="y">the y coordinate the center of the circle</param>
        /// <param name="penWidth">The width of the circle if it's not filled.</param>

...
{
    /// <summary>
    /// This Class handles if statments and loops and any other errors
    /// </summary>
    public class CommandParser
    {
        ...
        public CommandParser(Drawer drawingClass)
        {
            ...
            colours.Add("yellow", (255, 221, 191, 255));
            context = new Context();
        ...
        /// <exception cref="Exception">Exception that is thrown when the colour does not exist</exception>
        ...
        /// <returns></returns>
        /// <exception cref="Exception">Thrown when a point string is invalid.</exception>
            ...
            if (processLine)
            {
                switch (words[0].ToLower())
                {
                    ...
                    case "pen":
                        ...
                        {
                            throw new Exception("Invalid number of attributes for command pen");
                        }
                        break;
                    ...
                    case "fill":
                        if (words.Length == 2)
                        {
                            ...
                            {
                                throw new Exception("Invalid attributes for fill state command");
                            }
                        }
                        else
                        {
